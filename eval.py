...
def main():
    ...
    parser.add_argument('--model_path', default='D:\SpongeBobPro\pretrain_model\pretrain_1024.pth', type=str, help="模型权重路径（.pth文件）")
    parser.add_argument('--tokenizer_path', default='D:\\SpongeBobPro\\tokenizer_15k', type=str, help="Tokenizer路径")
